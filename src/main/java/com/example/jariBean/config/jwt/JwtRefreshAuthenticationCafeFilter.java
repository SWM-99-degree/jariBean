...
public class JwtRefreshAuthenticationCafeFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public JwtRefreshAuthenticationCafeFilter(AuthenticationManager authenticationManager, TokenRepository tokenRepository) {
        super(authenticationManager);
        setFilterProcessesUrl("/api/cafes/refreshtoken"); // 고객 로그인 URL 지정
